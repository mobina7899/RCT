...
class Role extends Model implements RoleContract
{
    ...
    public static function attachPermiisions($role , array $array){

        foreach ($array as $perrmission){
            $role->permission()->attach(Permission::where('name',$perrmission)->first()->id);
        }
    }
}

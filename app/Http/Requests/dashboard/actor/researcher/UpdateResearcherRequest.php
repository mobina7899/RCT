...
namespace App\Http\Requests\dashboard\actor\researcher;
...
class UpdateResearcherRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'n_number'=>['required', 'digits:10' , 'numeric', Rule::unique('researchers')->ignore($this->id)],
            ...
            'proficiency'=>'nullable|regex:/^[\x{600}-\x{6FF}\x{200c}\x{064b}\x{064d}\x{064c}\x{064e}\x{064f}\x{0650}\x{0651}a-zA-Z0-9.,\s]+$/u',
            'university'=>'required|regex:/^[\x{600}-\x{6FF}\x{200c}\x{064b}\x{064d}\x{064c}\x{064e}\x{064f}\x{0650}\x{0651}a-zA-Z0-9.,\s]+$/u',
            'organization'=>'nullable|regex:/^[\x{600}-\x{6FF}\x{200c}\x{064b}\x{064d}\x{064c}\x{064e}\x{064f}\x{0650}\x{0651}a-zA-Z0-9.,\s]+$/u',
        ];
    }
}

...
//         .hover(
//           function () {
//             n(a, this).stop().animate({ opacity: 1 }, 0, "linear");
//           },
//           function () {
//             n(a, this).stop().animate({ opacity: 0 }, 0, "linear");
//           }
//         ),
...
!(function (l, e) {
  ...
  function e(e) {
    ...
    if (!t.data.outer) {
      ...
      (t.data.inner = l("<div>").css(l.extend({}, s))),
        (t.data.outer = l("<div>")
          .css(
            l.extend(
              {
      ...
      t.scroll ||
        ...
        l(window).resize(function () {
          ...
          if (t.scroll && (t.scroll.height || t.scroll.width)) {
            var s = e();
            (s.height === t.scroll.height && s.width === t.scroll.width) ||
              ((t.scroll = s), (l = !0));
          }
          c(l);
        })),
  ...
  n.prototype = {
    ...
    init: function (e) {
      ...
      if (
        (t.mobile && a.ignoreMobile) ||
        (t.overlay && a.ignoreOverlay) ||
        (t.macosx && !t.webkit)
      )
        return l.isFunction(a.onFallback) && a.onFallback.apply(this, [r]), !1;
      if (d)
        (u = {
          height: "auto",
          ...
          (u[a.isRtl ? "margin-left" : "margin-right"] =
            t.scroll.width * -1 + "px"),
          i.css(u);
      else {
        if (
          ...
          (u[a.isRtl ? "margin-left" : "margin-right"] =
            t.scroll.width * -1 + "px"),
          i.addClass("scroll-content").css(u),
            ...
            return (
              t ||
                ("x" === e && l.originalEvent.deltaX
                  ? (t = 40 * l.originalEvent.deltaX)
                  : "y" === e &&
                    l.originalEvent.deltaY &&
                    (t = 40 * l.originalEvent.deltaY)),
              ((t > 0 && v < n) || (t < 0 && v > 0)) &&
                ((v += t),
                v < 0 && (v = 0),
                v > n && (v = n),
                ...
                setTimeout(function () {
                  s.scrollTo &&
                    (r.stop().animate(s.scrollTo, 240, "linear", function () {
                      v = r[h]();
                    }),
                    (s.scrollTo = null));
                }, 1)),
          ...
          i.scroll
            ...
            .on("mousedown" + n, function (o) {
              ...
              var n = {
                  ...
                  scrollbarOffset:
                    i.scroll.bar.offset()["x" === e ? "left" : "top"],
                  scrollbarSize:
                    i.scroll.bar["x" === e ? "outerWidth" : "outerHeight"](),
                },
                c = 0,
                m = 0;
              if (l(this).hasClass("scroll-arrow")) {
                if (
                  ((u = l(this).hasClass("scroll-arrow_more") ? 1 : -1),
                  (p = a.scrollStep * u),
                  (v = u > 0 ? n.maxScrollValue : 0),
                  a.isRtl)
                )
                  switch (!0) {
                    case t.firefox:
              ...
              } else (u = n.eventOffset > n.scrollbarOffset + n.scrollbarSize ? 1 : n.eventOffset < n.scrollbarOffset ? -1 : 0), "x" === e && a.isRtl && (t.msie || t.msedge) && (u *= -1), (p = Math.round(0.75 * i.visible) * u), (v = n.eventOffset - n.scrollbarOffset - (a.stepScrolling ? (1 == u ? n.scrollbarSize : 0) : Math.round(n.scrollbarSize / 2))), (v = r[h]() + v / i.kx);
              return (
                (s.scrollTo = s.scrollTo || {}),
                ...
                setTimeout(function () {
                  s.scrollTo &&
                    (r.animate(s.scrollTo, a.duration), (s.scrollTo = null));
                }, 1),
    ...
    _updateScroll: function (e, s) {
      ...
      (s.isVisible = d - u > 1),
        s.isVisible
          ? (s.scroll.addClass(i), n.scroll.addClass(i), r.addClass(i))
        ...
        "y" === e &&
          (o.is("textarea") || d < u
            ...
            : r.css({ "max-height": u + t.scroll.height + "px" })),
        ...
        (a = t.scrolls[o]),
          ...
          (s ||
            (n.autoUpdate &&
              d &&
              d.is(":visible") &&
              (i.prop("scrollWidth") != u.size ||
                i.prop("scrollHeight") != h.size ||
                d.width() != u.visible ||
                d.height() != h.visible))) &&
            (a.init(),
            n.debug &&

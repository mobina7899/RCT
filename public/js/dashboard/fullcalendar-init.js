      ...
      i.append("<label>Change event name</label>"),
        i.append(
          "<div class='input-group'><input class='form-control' type=text value='" +
            t.title +
            "' /><span class='input-group-btn'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fa-solid fa-check'></i> Save</button></span></div>"
        ),
          ...
          return (
            null !== e && 0 != e.length
              ? (o.$calendarObj.fullCalendar(
                  "renderEvent",
                  { title: e, start: t, end: n, allDay: !1, className: a },
                  !0
                ),
                o.$modal.modal("hide"))
    ...
    (t.prototype.init = function () {
      ...
      var t = new Date(),
        ...
        a = [
          ...
          { title: "Soft drinks", start: n, end: n, className: "bg-danger" },
          {
            title: "Hot dog",
          ...
          null !== e &&
            ...
            (o.$extEvents.append(
              '<div class="external-event bg-' +
                ...
                '" data-class="bg-' +
                t +
                '" style="position: relative;"><i class="fa-solid fa-move"></i>' +
                e +
                "</div>"
            ),
            o.enableDrag());

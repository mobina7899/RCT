(function ($) {
    ...
    new Chart(areaChart_2, {
      ...
      options: {
        ...
        scales: {
          ...
          xAxes: [{ ticks: { padding: 2 }, display: false }],
        },
      },
    });
  }
  ...
  if (jQuery("#lineChart_3Kk").length > 0) {
    ...
    const lineChart_3Kk = document
      .getElementById("lineChart_3Kk")
      .getContext("2d");
    const lineChart_3gradientStroke1 = lineChart_3Kk.createLinearGradient(
      500,
      0,
      100,
      0
    ...
    const lineChart_3gradientStroke2 = lineChart_3Kk.createLinearGradient(
      500,
      0,
      100,
      0
    ...
    new Chart(lineChart_3Kk, {
      ...
      options: {
        ...
        scales: {
          ...
          xAxes: [{ ticks: { padding: 5 }, display: false }],
        },
      },
    });
  }
  ...
  if (jQuery("#chart_widget_5").length > 0) {
    new Chartist.Line(
      "#chart_widget_5",
      {
        ...
        series: [[4, 5, 3.5, 4, 5, 5.5, 5.8, 4.6]],
      },
      {
        low: 0,
        showArea: 1,
        ...
        fullWidth: !0,
        lineSmooth: !1,
        chartPadding: { top: 2, right: 0, bottom: 0, left: 0 },
  ...
  if (jQuery("#ShareProfit2").length > 0) {
    const ShareProfit2 = document
      .getElementById("ShareProfit2")
      .getContext("2d");

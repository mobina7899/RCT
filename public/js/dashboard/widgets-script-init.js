(function ($) {
    ...
    var config = {
      ...
      options: {
        ...
        scales: {
          yAxes: [
            {
              gridLines: { color: "rgba(89, 59, 219,0.1)", drawBorder: true },
              ticks: { fontColor: "#999" },
            },
          ],
          xAxes: [
            {
              gridLines: { display: false, zeroLineColor: "transparent" },
              ticks: {
                stepSize: 5,
                fontColor: "#999",
      ...
      options: {
        ...
        scales: {
          ...
          yAxes: [
            {
              display: !1,
              ticks: { padding: 10, stepSize: 20, max: 100, min: 0 },
              gridLines: {
                display: !0,
                drawBorder: !1,
                lineWidth: 1,
        ...
        datasets: [
          {
            ...
            data: [
              ...
              12, 19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21,
              17,
            ],
          },
        ],
  ...
  if (jQuery("#chart_widget_10").length > 0) {
    const chart_widget_10 = document
  ...
  if (jQuery("#chart_widget_11").length > 0) {
    const chart_widget_11 = document
      ...
      options: {
        ...
        scales: {
          ...
          xAxes: [
            {
              display: false,
              ticks: { padding: 0, display: false, beginAtZero: true },
              gridLines: { display: false, drawBorder: false },
            },
          ],
        },
  ...
  if (jQuery("#chart_widget_17").length > 0) {
    ...
    if (jQuery("#chart_widget_17").length > 0) {
      const chart = $.plot("#chart_widget_17", [getRandomData()], {
        colors: ["#00abc5"],
        series: {
          lines: { show: true, lineWidth: 0, fill: 0.9 },
          shadowSize: 0,
        },
        grid: { borderColor: "transparent", borderWidth: 0, labelMargin: 0 },
        xaxis: { color: "transparent", font: { size: 10, color: "#fff" } },
        yaxis: {
          min: 0,
          max: 100,
          color: "transparent",
  ...
  if (jQuery("#widget_sparklinedash").length > 0) {
    $("#widget_sparklinedash").sparkline(
      [10, 15, 26, 27, 28, 31, 34, 40, 41, 44, 49, 64, 68, 69, 72],
      {
        type: "bar",
        height: "40",
        width: "40",
...
if (jQuery("#widget_composite-bar").length > 0) {
  $("#widget_composite-bar").sparkline(
    [
      73, 53, 50, 67, 3, 56, 19, 59, 37, 32, 40, 26, 71, 19, 4, 53, 55, 31, 37,
      67, 10, 21,
    ],
    {
      type: "bar",

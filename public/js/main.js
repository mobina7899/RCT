...
function windowLoadInit() {
    ...
    setTimeout(function () {
        ...
        if ($header.length) {
            ...
            jQuery($header).on(
                "affixed-top.bs.affix affixed.bs.affix",
                function (e) {
                    if ($header.hasClass("affix-top")) {
                        ...
                        $header
                            .parent()
                            .removeClass(
                                "affix-top-wrapper affix-bottom-wrapper"
                            )
        ...
        jQuery(".to_animate")
            ...
            .each(function (index) {
                ...
                var animationClass = !self.data("animation")
                    ? "fadeInUp"
                    : self.data("animation");
                var animationDelay = !self.data("delay")
                    ? 210
                    : self.data("delay");
                setTimeout(function () {
                    self.addClass("animated " + animationClass);
...
$(document).ready(function () {
    let owl = $(".owl-carousel:not(.owl-sponsor , .owl-comments , .owl-news)");
    owl.owlCarousel({
...
var $circleInner = $(".circle-inner");
var $circleOuter = $(".circle-outer");
var $txtBox = $(".txt-box");

/* Hide all content boxes */
$txtBox.not("#txt-default").each(function () {
    $(this).hide();
});

/* large circles */
$circleInner.on("click mouseover", function () {
    $circleInner.removeClass("active-circle-inner");
    $circleOuter.removeClass("active-circle-outer");
    $(this).addClass("active-circle-inner");
    $(".active-stroke").removeClass("active-stroke");
    $(".active-stroke-solid").removeClass("active-stroke-solid");
...
/* smaller circles */
$circleOuter.on("click mouseover", function () {
    // $circleOuter.click(function () {
    $circleOuter.removeClass("active-circle-outer");
    $circleInner.removeClass("active-circle-inner");
    $(this).addClass("active-circle-outer");
    $(".active-stroke").removeClass("active-stroke");
    $(".active-stroke-solid").removeClass("active-stroke-solid");

    var $dataContent = $(this).attr("data-content");

    if ($(this).attr("data-content") === "pill-plus") {
        $(".pill-plus-line").addClass("active-stroke");
    }
    if ($(this).attr("data-content") === "sunshine-act") {
        $(".sunshine-act-line").addClass("active-stroke");
    }
    if ($(this).attr("data-content") === "publications") {
        $(".publications-line").addClass("active-stroke");
    }
    if ($(this).attr("data-content") === "clinical-trials") {
        $(".clinical-trials-line").addClass("active-stroke");
    }
    if ($(this).attr("data-content") === "therapeutic-area") {
        $(".therapeutic-area-line").addClass("active-stroke");
    }
    if ($(this).attr("data-content") === "therapeutic-area") {
        $(".therapeutic-area-line-solid").addClass("active-stroke-solid");
    }
    if ($(this).attr("data-content") === "advocacy") {
        $(".advocacy-line-solid").addClass("active-stroke-solid");
    }
    if ($(this).attr("data-content") === "media") {
        $(".media-line-solid").addClass("active-stroke-solid");
    }
    if ($(this).attr("data-content") === "media") {
        $(".media-line").addClass("active-stroke");
    }
...
$(document).ready(function () {
    if (window.innerWidth > 1400) {
        $("#svg1").css("transform", "scale(0.5)");
        $("#svg1").css("top", "calc(26% - 30px)");
    } else if (window.innerWidth < 992) {
        $("#svg1").css("transform", "scale(0.35)");
        $("#svg1").css("top", "calc(23% - 30px)");
        $("#svg1").css("right", "calc(50% - 95px)");
    } else {
        $("#svg1").css("transform", "scale(0.45)");
        $("#svg1").css("top", "calc(25% - 30px)");
        $("#svg1").css("right", "calc(50% - 90px)");
    }

    if (window.innerWidth > 1400) {
        $("#svg2").css("transform", "scale(0.5)");
        $("#svg2").css("top", "calc(45% - 30px)");
        $("#svg2").css("right", "24%");
    } else if (window.innerWidth > 1200) {
        $("#svg2").css("top", "calc(44% - 30px)");
    } else if (window.innerWidth < 992) {
        $("#svg2").css("transform", "scale(0.35)");
        $("#svg2").css("top", "calc(41% - 30px)");
        $("#svg2").css("right", "19%");
    } else {
        $("#svg2").css("transform", "scale(0.45)");
        $("#svg2").css("top", "calc(43% - 30px)");
        $("#svg2").css("right", "22%");
    }

    if (window.innerWidth > 1400) {
        $("#svg3").css("transform", "scale(0.5)");
        $("#svg3").css("top", "calc(63% - 30px)");
    } else if (window.innerWidth < 992) {
        $("#svg3").css("transform", "scale(0.35)");
        $("#svg3").css("top", "calc(58% - 30px)");
        $("#svg3").css("right", "calc(50% - 95px)");
    } else {
        $("#svg3").css("transform", "scale(0.45)");
        $("#svg3").css("top", "calc(61% - 30px)");
        $("#svg3").css("right", "calc(50% - 90px)");
    }

    if (window.innerWidth > 1400) {
        $("#svg4").css("transform", "scale(0.5)");
        $("#svg4").css("top", "calc(45% - 30px)");
        $("#svg4").css("left", "23%");
    } else if (window.innerWidth > 1200) {
        $("#svg4").css("top", "calc(44% - 30px)");
        $("#svg4").css("left", "22%");
    } else if (window.innerWidth < 992) {
        $("#svg4").css("transform", "scale(0.35)");
        $("#svg4").css("top", "calc(41% - 30px)");
        $("#svg4").css("left", "18%");
    } else {
        $("#svg4").css("transform", "scale(0.45)");
        $("#svg4").css("top", "calc(43% - 30px)");
        $("#svg4").css("left", "21%");
    }
...
$(document).ready(function () {
    $(".post-cats .cats-body ul").slideToggle();
    $(".post-cats .cats-body>li").on("click", function (event) {
        $(this).find(">ul").slideToggle();
    });

    $(document).on("submit", "#suggestion-form", function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                Swal.fire("ثبت!", "پیشنهاد شما ثبت شد", "success");

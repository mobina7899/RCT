    ...
    <div class="fixed-content-body dz-scroll" id="DZ_W_Fixed_Contant">
        <div class="tab-content" id="menu">
                ...
                <ul class="metismenu tab-nav-menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="index-2.html">تاریک</a></li>
            ...
            <div class="tab-pane fade" id="apps">
                <ul class="metismenu tab-nav-menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">ایمیل</a>
                                <ul aria-expanded="false">
                                    <li><a href="email-compose.html">ساختن</a></li>
                                    <li><a href="email-inbox.html">صندوق ورودی</a></li>
                                    <li><a href="email-read.html">خواندن</a></li>
                                </ul>
                            </li>
                            <li><a href="app-calender.html">تقویم</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">خرید
                                    کنید</a>
                                <ul aria-expanded="false">
                                    <li><a href="ecom-product-grid.html">گرید محصول</a></li>
                                    <li><a href="ecom-product-list.html">لیست محصولات</a></li>
                                    <li><a href="ecom-product-detail.html">مشخصات محصول</a></li>
                                    <li><a href="ecom-product-order.html">سفارش</a></li>
                                    <li><a href="ecom-checkout.html">وارسی</a></li>
                                    <li><a href="ecom-invoice.html">صورتحساب</a></li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">نمودار</span>
                            <span class="badge badge-xs badge-light">06</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">عالی</a></li>
                            <li><a href="chart-morris.html">Morris</a></li>
                            <li><a href="chart-chartjs.html">Chartjs</a></li>
                            <li><a href="chart-chartist.html">Chartist</a></li>
                            <li><a href="chart-sparkline.html">Sparkline</a></li>
                            <li><a href="chart-peity.html">تقوا</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                ...
                <ul class="metismenu tab-nav-menu">
                    ...
                    <li class="mega-menu mega-menu-xl">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">بوت استرپ</span>
                            <span class="badge badge-xs badge-light">17</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="ui-accordion.html">آکاردئون</a></li>
                            <li><a href="ui-alert.html">هشدار</a></li>
                            <li><a href="ui-badge.html">نشان</a></li>
                            <li><a href="ui-button.html">دکمه</a></li>
                            <li><a href="ui-modal.html">مدال</a></li>
                            ...
                            <li><a href="ui-card.html">کارت ها</a></li>
                            <li><a href="ui-carousel.html">چرخ فلک</a></li>
                            <li><a href="ui-dropdown.html">کشویی</a></li>
                            <li><a href="ui-popover.html">پاپاور</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="uc-select2.html">انتخاب کنید 2</a></li>
                            <li><a href="uc-nestable.html">تودرتو</a></li>
                            <li><a href="uc-noui-slider.html">نویزلایدر</a></li>
                            <li><a href="uc-sweetalert.html">هشدار شیرین</a></li>
                            <li><a href="uc-toastr.html">نان تست</a></li>
                            <li><a href="map-jqvmap.html">نقشه Jqv</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="icon-svg.html" class="ai-icon" aria-expanded="false">
                            ...
                            <span class="nav-text">SVG ایکون</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="tab-pane fade" id="forms">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">فرم ها</li>
                      @can('read-study')
                        <li><a href="{{route('study')}}" aria-expanded="false">
                                <span class="nav-text">طرح ها</span>
                            </a>
                        </li>
                    @endcan
                        @if(auth()->user()->hasRole('Researcher'))
                            <li><a href="{{route('assistant')}}" aria-expanded="false">
                                    <span class="nav-text">دستیار ها</span>
                                </a>
                            </li>
                        @endif
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="form-wizard.html">جادوگر</a></li>
                            <li><a href="form-editor-summernote.html">یادداشت تابستانی</a></li>
                            <li><a href="form-pickers.html">انتخاب کنندگان</a></li>
            ...
            <div class="tab-pane fade" id="table">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">جدول</li>
                    @can('read-patient')
                        <li><a href="{{route('patient')}}">
                                بیمار
                            </a>
                        </li>
                        @endcan
                    @can('read-user')
                       <li><a class="has-arrow ai-icon">
                           ...
                           <ul aria-expanded="false">
                               <li><a href="{{route('user',['role'=>'User'])}}">کاربر</a></li>
                               <li><a href="{{route('user',['role'=>'Supervisor'])}}">ناظر</a></li>
                               <li><a href="{{route('user',['role'=>'Agent'])}}">بیمارگیر</a></li>
                               <li><a href="{{route('user',['role'=>'Admin'])}}">ادمین</a></li>
                    ...
                    @endcan
                    @can('read-comment')
                        <li><a href="{{route('comment')}}">
                                نظرات
                            </a>
                        </li>
                    @endcan
                    @can('read-slider')
                        <li><a href="{{route('slider')}}">
                                اسلایدر
                            </a>
                        </li>
                    @endcan
                    ...
                    @can('read-user')
                        <li><a class="has-arrow ai-icon">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="{{route('post')}}">پست</a></li>
                                <li><a href="{{route('tag')}}">تگ و دسته بندی</a></li>
        ...
        <div class="tab-pane chart-sidebar fade show active" role="tabpanel">
            <div class="card">
                <div class="card-header align-items-start">
                    <div>
                        <h6>فروش روزانه</h6>
                        <p>برای جزئیات بیشتر، هر ستون را بررسی کنید</p>
                    </div>
                    <span class="btn btn-primary light sharp mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <div class="card bg-warning-light">
                <div class="card-header align-items-start mb-3">
                    ...
                    <span class="btn btn-warning light sharp mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             width="20px" height="20px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                ...
                <div class="card-body">
                    <div class="chart-point">
                        ...
                        <ul class="chart-point-list">
                            ...
                            <li><i class="fa-solid fa-circle text-success ml-1"></i> 35% رویداد</li>
                            <li><i class="fa-solid fa-circle text-warning ml-1"></i> 25% سایر</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="card bg-info-light">
                <div class="card-header align-items-start mb-3">
                    <div>
                        <h6>بازدیدکنندگان توسط مرورگر</h6>
                        <p>برای جزئیات بیشتر، هر ستون را بررسی کنید</p>
                    </div>
                    <span class="btn btn-info light sharp mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                             width="20px" height="20px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                ...
                <div class="card-body">
                    <p class="mb-2 d-flex"><img width="22" height="22" src="{{asset('/images/dashboard/icon1.png')}}"
                                                class="ml-2"
                                                alt>فتوشاپ
                        <span class="pull-left text-warning mr-auto">85%</span>
                    </p>
                    ...
                    <p class="mb-2 d-flex"><img width="22" height="22" src="{{asset('/images/dashboard/icon2.png')}}"
                                                class="ml-2"
                                                alt>ویرایشگر کد
                        <span class="pull-left text-success mr-auto">90%</span>
                    </p>
                    <div class="progress mb-3" style="height:4px">
                    ...
                    <p class="mb-2 d-flex"><img width="22" height="22" src="{{asset('/images/dashboard/icon1.png')}}"
                                                class="ml-2"
                                                alt>تصویرگر
                        <span class="pull-left text-danger mr-auto">65%</span>
                    </p>

                        ...
                        <div class="col-12 col-md-10 row px-0 position-relative">
                            ...
                            <div class="col-12 col-md-10 ">
                                <div class="questions-container">
                                    ...
                                    <form id="study-form" action="{{route('study.update')}}" method="POST" data-id=""
                                        ...
                                        <div class="step-container" id="1">
                                            ...
                                            <div class="form-group">
                                                <div class="col-12 col-md-6 px-2">
                                                    ...
                                                    <input type="hidden" name="dates" value="{{ $startdate }}">
                                                ...
                                                <div class="col-12 col-md-6 px-2">
                                                    ...
                                                    <input value="{{ old('name') }}" type="text" class="form-control"
                                                        name="name" placeholder="نام اختصاری" />
                                                    <div class="errors text-danger fs-6">
                                                        @error('name')
                                                            {{ $message }}
                                                        @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-12 col-md-6 px-2 ">
                                                    ...
                                                    <select type="text" name="studies_type" class="form-select">
                                                        <option value="پرسشگری" selected>پرسشگری</option>
                                                ...
                                                <div class="col-12 col-md-6 px-2">
                                                    ...
                                                    <select name="study_design" class="form-select">
                                                        <option selected value="موازی">موازی</option>
                                            ...
                                            <div class="form-group">
                                                <div class="col-12 col-md-6 px-2 position-relative date-inputs">
                                                    ...
                                                    <input value="{{ old('start_date') }}" type="text"
                                                        class="form-control dates" id="date1" name="start_date"
                                                ...
                                                <div class="col-12 col-md-6 px-2 position-relative date-inputs">
                                                    ...
                                                    <input value="{{ old('end_date') }}" type="text"
                                                        class="form-control dates" id="date2" name="end_date"
                                            ...
                                            <div class="form-group">
                                                <div class="upload-main-wrapper px-1 pt-4">
                                                    ...
                                                    <div class="errors text-danger h-auto fs-6">
                                                        @error('file')
                                                            {{ $message }}
                                                        @enderror
                                            ...
                                            <div class="form-group">
                                                <div class="col-12 col-md-6 col-lg-5 px-2">
                                                    ...
                                                    <select name="purpose_study" class="form-select">
                                                        <option value="1"
                                                            {{ old('purpose_study') == '1' ? 'selected' : '' }}>علوم
                                                            پایه
                                                        </option>
                                                        <option value="2"
                                                            {{ old('purpose_study') == '2' ? 'selected' : '' }}>تشخیصی
                                                        </option>
                                                        <option value="3"
                                                            {{ old('purpose_study') == '3' ? 'selected' : '' }}>تحقیقات
                                                            در
                                                            سیستم ارایه خدمات سلامت
                                                        </option>
                                                        <option value="4"
                                                            {{ old('purpose_study') == '4' ? 'selected' : '' }}>پیشگیری
                                                        </option>
                                                        <option value="5"
                                                            {{ old('purpose_study') == '5' ? 'selected' : '' }}>غربالگری
                                                        </option>
                                                        <option value="6"
                                                            {{ old('purpose_study') == '6' ? 'selected' : '' }}>حمایتی
                                                        </option>
                                                        <option value="7"
                                                            {{ old('purpose_study') == '7' ? 'selected' : '' }}>درمانی
                                                        </option>
                                                        <option value="8"
                                                            {{ old('purpose_study') == '8' ? 'selected' : '' }}>آموزشی /
                                                            مشاوره
                                                            ای
                                                        </option>
                                                        <option value="9"
                                                            {{ old('purpose_study') == '9' ? 'selected' : '' }}>موارد
                                                            دیگر
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-6 col-lg-5 px-2">
                                                    ...
                                                    <select name="phase_study" class="form-select">
                                                        <option value="1"
                                                            {{ old('phase_study') == '1' ? 'selected' : '' }}>0
                                                        </option>
                                                        <option value="2"
                                                            {{ old('phase_study') == '2' ? 'selected' : '' }}>1
                                                        </option>
                                                        <option value="3"
                                                            {{ old('phase_study') == '3' ? 'selected' : '' }}>1-2
                                                        </option>
                                                        <option value="4"
                                                            {{ old('phase_study') == '4' ? 'selected' : '' }}>2
                                                        </option>
                                                        <option value="5"
                                                            {{ old('phase_study') == '5' ? 'selected' : '' }}>2-3
                                                        </option>
                                                        <option value="6"
                                                            {{ old('phase_study') == '6' ? 'selected' : '' }}>3
                                                        </option>
                                                        <option value="7"
                                                            {{ old('phase_study') == '7' ? 'selected' : '' }}>4
                                                        </option>
                                                        <option value="8"
                                                            {{ old('phase_study') == '8' ? 'selected' : '' }}>هم ارزی
                                                            زیستی
                                                        </option>
                                                        <option value="9"
                                                            {{ old('phase_study') == '9' ? 'selected' : '' }}>مصداق
                                                            ندارد
                                                        </option>
                                                    </select>
                                                ...
                                                <div class="col-12 col-lg-2 px-2 align-self-end pb-3">
                                                    ...
                                                    <input {{ old('placebo') == 'on' ? 'checked' : '' }} type="checkbox"
                                                        name="placebo" class="form-check-input" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-12 col-md-6 px-2">
                                                    ...
                                                    <select class="form-select" name="randomization">
                                                        <option value="1"
                                                            {{ old('randomization') == 1 ? 'selected' : '' }}>اختصاص
                                                            تصادفی
                                                            به
                                                            گروه های مداخله و کنترل
                                                        </option>
                                                        <option value="2"
                                                            {{ old('randomization') == 2 ? 'selected' : '' }}>اختصاص
                                                            غیرتصادفی
                                                            به گروه های مداخله و
                                                            کنترل
                                                        </option>
                                                        <option value="3"
                                                            {{ old('randomization') == 3 ? 'selected' : '' }}>مصداق
                                                            ندارد
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-6 px-2">
                                                    ...
                                                    <select class="form-select" name="blinding">
                                                        <option value="1"
                                                            {{ old('blinding') == 1 ? 'selected' : '' }}>
                                                            کور نشده است
                                                        </option>
                                                        <option value="2"
                                                            {{ old('blinding') == 2 ? 'selected' : '' }}>
                                                            افراد شرکت کننده در مطاله
                                                        </option>
                                                        <option value="3"
                                                            {{ old('blinding') == 3 ? 'selected' : '' }}>
                                                            افراد شرکت کننده و ارزیابی کننده پیامد در مطالعه
                                                        </option>
                                                        <option value="4"
                                                            {{ old('blinding') == 4 ? 'selected' : '' }}>
                                                ...
                                                <div id="intervention_box" class="px-0">
                                                    ...
                                                    <div class="intervention-body">
                                                        ...
                                                        <div class="row intervention-fields">
                                                            ...
                                                            <div class=" col-12 pt-2">
                                                                <button type="button" class="btn btn-danger"
                                                                    id="delete_fields">حذف این مورد
                                                                </button>
                                                                <button type="button" class="btn btn-primary mr-2"
                                                                    id="record_intervention">افزودن این مورد
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="d-flex flex-column h-100">
                                                ...
                                                <div class="form-group border rounded mb-2 pb-1">
                                                    <div class="col-12 px-2 pb-0 position-relative">
                                                        ...
                                                        <input class="form-control" name="entry_study" />
                                                        <i class="fa-solid fa-plus"></i>
                                                        <div class="errors text-danger fs-6">
                                                            @error('entry_study')
                                                                {{ $message }}
                                                ...
                                                <div class="form-group">
                                                    <div class="col-12 px-2">
                                                        <input {{ old('termination_illness') == 'on' ? 'checked' : '' }}
                                                            type="checkbox" name="termination_illness"
                                                            class="form-check-input" />
                                                        <label><strong>بیمارگیری خاتمه یافته است</strong></label>
                                                    </div>
                                                    <div class="col-12 col-md-6 px-2 position-relative date-inputs">
                                                        <label>
                                                            <strong>{{ old('termination_illness') == 'on' ? 'تاریخ شروع بیمارگیری خاتمه یافته :' : 'تاریخ شروع بیمارگیری :' }}</strong>
                                                        </label>
                                                        <input
                                                            value="{{ old(old('termination_illness') == 'on' ? 'start_get_sick_ended' : 'start_date_illness') }}"
                                                            type="text" class="form-control dates" id="date3"
                                                            name="{{ old('termination_illness') == 'on' ? 'start_get_sick_ended' : 'start_date_illness' }}"
                                                            placeholder="تاریخ شروع" />
                                                        <i class="fa-solid fa-calendar-days fs-4"></i>
                                                        <div class="errors text-danger fs-6">
                                                    ...
                                                    <div class="col-12 col-md-6 px-2 position-relative date-inputs">
                                                        <label>
                                                            <strong>
                                                                {{ old('termination_illness') == 'on' ? 'تاریخ پایان بیمارگیری خاتمه یافته :' : 'تاریخ پایان بیمارگیری :' }}</strong>
                                                        </label>
                                                        <input
                                                            value="{{ old(old('termination_illness') == 'on' ? 'end_get_sick_ended' : 'end_date_illness') }}"
                                                            type="text" class="form-control dates" id="date4"
                                                            name="{{ old('termination_illness') == 'on' ? 'end_get_sick_ended' : 'end_date_illness' }}"
                                                            placeholder="تاریخ پایان" />
                                                        <i class="fa-solid fa-calendar-days fs-4"></i>
                                                        <div class="errors text-danger fs-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <input {{ old('minimum_age') == 'on' ? 'checked' : '' }}
                                                            type="checkbox" name="minimum_age" class="form-check-input"
                                                            id="min-age-check" />
                                                        ...
                                                        <div class="date-box">
                                                            <div class="row mx-0 my-2">
                                                                ...
                                                                <input value="{{ old('min_year', 0) }}" type="number"
                                                                    disabled name="min_year"
                                                            ...
                                                            <div class="row mx-0 my-2">
                                                                ...
                                                                <input value="{{ old('min_month', 0) }}" type="number"
                                                                    disabled name="min_month"
                                                                    class="col-6 form-control age-fields" />
                                                                <div class="errors text-danger fs-6"></div>
                                                            </div>
                                                            <div class="row mx-0 my-2">
                                                                ...
                                                                <input value="{{ old('min_day', 0) }}" type="number"
                                                                    disabled name="min_day"
                                                                    class="col-6 form-control age-fields" />
                                                                <div class="errors text-danger fs-6"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <input {{ old('maximum_age') == 'on' ? 'checked' : '' }}
                                                            type="checkbox" name="maximum_age" class="form-check-input"
                                                            id="max-age-check" />
                                                        ...
                                                        <div class="date-box">
                                                            <div class="row mx-0 my-2">
                                                                ...
                                                                <input value="{{ old('max_year', 0) }}" type="number"
                                                                    disabled name="max_year"
                                                                    class="col-6 form-control age-fields" />
                                                                <div class="errors text-danger fs-6"></div>
                                                            </div>
                                                            <div class="row mx-0 my-2">
                                                                ...
                                                                <input value="{{ old('max_month', 0) }}" type="number"
                                                                    disabled name="max_month"
                                                                    class="col-6 form-control age-fields" />
                                                                <div class="errors text-danger fs-6"></div>
                                                            </div>
                                                            <div class="row mx-0 my-2">
                                                                ...
                                                                <input value="{{ old('max_day', 0) }}" type="number"
                                                                    disabled name="max_day"
                                                                    class="col-6 form-control age-fields" />
                                                                <div class="errors text-danger fs-6"></div>
                                                            </div>
                                                        </div>
...
{{--                                        <div id="shortNext" class="text-center">--}}
{{--                                            <button type="button" class="btn btn-primary">بعدی<i--}}
{{--                                                    class="fa-solid fa-angles-left align-middle mr-1"></i></button>--}}
{{--                                        </div>--}}
                                    </form>

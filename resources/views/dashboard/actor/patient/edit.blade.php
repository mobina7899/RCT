            ...
            <div class="container-fluid">
                <div class="row mx-0">
                    <div class="create-designer content-main-box col-12">
                        ...
                        <form id="create_patient" action="{{ route('patient.update' , ['id'=>$patient->id]) }}"
                              method="POST"
                              autocomplete="off">
                            @csrf
                            @method('put')
                            <div class="create-designer-content">
                                ...
                                <div class="form-group">
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('username' , $patient->user->username)}}" type="text"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('email', $patient->user->email)}}" type="email"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <select name="enabled" id="enabled" class="form-select ">
                                            <option
                                                {{old('enabled' , $patient->status) == '1' ? 'selected' : ''}} value="1">
                                                فعال
                                            </option>
                                            <option
                                                {{old('enabled' , $patient->status) == '0' ? 'selected' : ''}} value="0">
                                                غیرفعال
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="create-designer-content">
                                <div class="form-group">
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('name' , $patient->name)}}" type="text" class="form-control"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4  px-2">
                                        ...
                                        <input value="{{old('f_name' , $patient->f_name)}}" type="text"
                                               class="form-control"
                                               name="f_name" placeholder="نام خانوادگی"/>
                                        <div class="errors text-danger">
                                            @error('f_name')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('n_number' , $patient->n_number)}}" type="text"
                                               class="form-control" name="n_number" placeholder="کدملی"/>
                                        <div class="errors text-danger">
                                            @error('n_number')
                                            {{ $message }}
                                            @enderror
                            ...
                            <div class="create-designer-content">
                                <div class="form-group">
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('birthdate' ,$patient->birthdate)}}" type="text" id="date2"
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <select name="marriage" class="form-select">
                                            <option value="0"
                                                {{ old('marriage', $patient->marriage) == 0 ? 'selected' : '' }}>
                                                مجرد
                                            </option>
                                            <option value="1"
                                                {{ old('marriage', $patient->marriage) == 1 ? 'selected' : '' }}>
                                                متاُهل
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('height', $patient->height)}}" type="number" class="form-control"
                                               name="height" placeholder="170 cm"/>
                                        <div class="errors text-danger">
                                            @error('height')
                                            {{ $message }}
                                            @enderror
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('weight', $patient->weight)}}" type="number" class="form-control"
                                               name="weight" placeholder="70 kg"/>
                                        <div class="errors text-danger">
                                            @error('weight')
                                            {{ $message }}
                                            @enderror
                                        ...
                                        <select name="province_id" class="form-select">
                                            @foreach (\App\Models\Province::all() as $province)
                                                <option value="{{ $province->id }}"
                                                    {{ old('province_id', $patient->province_id) == $province->id ? 'selected' : '' }}>
                                                    {{ $province->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <input value="{{old('sickness_id' , $patient->sickness->name)}}" class="sickness form-control" name="sickness_id"/>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 px-2">
                                        ...
                                        <textarea type="text" class="form-control" name="description"
                                                  placeholder="توضیحات">{{old('description' , $patient->description)}} </textarea>
                                        <div class="errors text-danger">
                                            @error('description')
                                            {{ $message }}
                                            @enderror
...
{{--                                                    {{ old('sickness_id', $patient->sickness_id) == $sickness->id ? 'selected' : '' }}>--}}
{{--                                                    {{ $sickness->name }}--}}
{{--                                                </option>--}}
{{--                                            @endforeach--}}
{{--                                        </select>--}}
{{--                                    </div>--}}
                            ...
                            <div class="px-2 pt-3">
                                <button type="submit" class="btn btn-primary">ویرایش بیمار</button>
                            </div>
                        </form>
                    </div>
                </div>

...
return [
    ...
    */
    'attributes' => [
        ...
        "price" => "قیمت",
        "off" => "تخفیف ماهانه" ,
        "start_date"=>"تاریخ شروع کارآزمایی",
        "end_date"=>"تاریخ پایان کارآزمایی",
        "top_title" => "عنوان فرعی",
        "body" => "متن",
        "tags" => "برچسب ها",
        ...
        "proficiency" => "تخصص" ,
        "img" => "عکس",
        "start_date_illness" => "تاریخ شروع بیمارگیری",
        "end_date_illness" => "تاریخ پایان بیمارگیری",
        "entry_study" => "شرایط ورود به مطالعه",
        "failure_entry_study" => "شرایط عدم ورود به مطالعه",
        "study_specifications" =>"مشخصات طراحی مطالعه",
        "start_get_sick_ended" => "تاریخ شروع بیمارگیری",
        "end_get_sick_ended" => "تاریخ پایان بیمارگیری",
        "dates" => "امروز",
        "name" => "نام",
        "username" => "نام کاربری",
